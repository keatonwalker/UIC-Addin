...
namespace UIC_Edit_Workflow {
    internal class Utils {
        ...
        /// <summary>
        ///     Get the ICommand interface for a given typed DAML representation like for example:
        ///     DAML.Button.esri_core_showProjectDockPane
        ...
        ///     Id of the command: use the typed DAML representation if possible to prevent errors i.e.
        ///     DAML.Button.esri_core_showProjectDockPane or the string itself "esri_core_contentsDockPane"
        /// </param>
